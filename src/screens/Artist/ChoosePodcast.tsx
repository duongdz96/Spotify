...
const ChoosePodCast = (): JSX.Element => {
                ...
                <>
                    <ScrollView contentContainerStyle={{
                        ...
                        {imageData.map((src, index) => (
                            <TouchableOpacity key={index} style={{ width: '33.33%', aspectRatio: 1, marginVertical: 15, }}
                                onPress={() => navigation.navigate('BottomTabNavigator', {
                                    screen: 'HomeNavigator',
                                })}
                            >
                                <Image source={src.image} style={{ width: 110, height: 110, borderRadius: 10 }} />
                                <Text style={{
                                    fontWeight: '600',
                                    fontSize: 12,
                                    textAlign: 'center',
